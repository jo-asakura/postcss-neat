...
var spanColumns = function spanColumns(columns) {
  var containerColumns = arguments.length <= 1 || arguments[1] === undefined ? _coreVariablesEs6Js2['default'].neatGridColumns : arguments[1];
  var display = arguments.length <= 2 || arguments[2] === undefined ? _coreVariablesEs6Js2['default'].neatDefaultDisplay : arguments[2];
  var direction = arguments.length <= 3 || arguments[3] === undefined ? _coreVariablesEs6Js2['default'].neatDefaultDirection : arguments[3];
  ...
  if (display === 'table') {
    ...
    return (_ref = {
      'display': 'block',
      'float': directions.oppositeDirection
    }, _defineProperty(_ref, 'margin-' + directions.direction, _coreFunctionsEs6Js2['default'].percentage(columnGutter)), _defineProperty(_ref, 'width', _coreFunctionsEs6Js2['default'].percentage(columnWidth)), _defineProperty(_ref, '&:last-child', _defineProperty({}, 'margin-' + directions.direction, 0)), _ref);
  }
};

...
functions = Object.assign(functions, {
  ...
  getDirection: function getDirection() {
    var layout = arguments.length <= 0 || arguments[0] === undefined ? 'LTR' : arguments[0];
  ...
  flexWidth: function flexWidth(columns, containerColumns) {
    var column = arguments.length <= 2 || arguments[2] === undefined ? _variablesEs6Js2['default'].neatColumnWidth : arguments[2];
    var gutter = arguments.length <= 3 || arguments[3] === undefined ? _variablesEs6Js2['default'].neatGutterWidth : arguments[3];
  ...
  flexGutter: function flexGutter() {
    var containerColumns = arguments.length <= 0 || arguments[0] === undefined ? _variablesEs6Js2['default'].neatGridColumns : arguments[0];
    var column = arguments.length <= 1 || arguments[1] === undefined ? _variablesEs6Js2['default'].neatColumnWidth : arguments[1];
    var gutter = arguments.length <= 2 || arguments[2] === undefined ? _variablesEs6Js2['default'].neatGutterWidth : arguments[2];
